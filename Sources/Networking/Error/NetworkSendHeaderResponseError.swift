//
//  NetworkSendHeaderResponseError.swift
//  Networking
//
...
/// Errors that can be thrown when sending a request that expects specific headers back
/// instead of a decoded body.
///
/// Thrown by:
/// - `NetworkClient.send(request: some NetworkRequestWithHeaderResponse)`
public enum NetworkSendHeaderResponseError: Error, Equatable {
    ...
    /// Required header fields are missing from the response.
    case headerFieldsMissing
}

extension NetworkSendHeaderResponseError {
